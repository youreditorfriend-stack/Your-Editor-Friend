...
// Fix: Define local components for Three.js elements to avoid JSX.IntrinsicElements errors in environments with strict TS checking
...
const MacroscopicWave = () => {
  ...
  return (
    <Torus ref={ref} args={[3, 0.1, 16, 100]} rotation={[Math.PI / 2, 0, 0]}>
      {/* Fix: Using MeshStandardMaterial constant to resolve JSX.IntrinsicElements error */}
  ...
  return (
    <div className="absolute inset-0 z-0 opacity-60 pointer-events-none">
      <Canvas camera={{ position: [0, 0, 6], fov: 45 }}>
        {/* Fix: Using AmbientLight and PointLight constants to resolve JSX.IntrinsicElements errors */}
  ...
  return (
    <div className="w-full h-full absolute inset-0">
      <Canvas camera={{ position: [0, 0, 4.5], fov: 45 }}>
        {/* Fix: Using AmbientLight, SpotLight, and PointLight constants to resolve JSX.IntrinsicElements errors */}
        ...
        <Float rotationIntensity={0.4} floatIntensity={0.2} speed={1}>
          {/* Fix: Using Group constant to resolve JSX.IntrinsicElements error */}
